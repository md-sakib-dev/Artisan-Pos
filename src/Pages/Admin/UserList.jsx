...
const EditUser = () => {
  return (
    <div className='mt-20 w-full h-full mx-auto '>
      ...
      <div class=" mt-5 flex flex-col gap-2 md:flex-row md:gap-4 justify-center items-center ">
...
<div className='flex flex-col justify-center items-center'>
   <div className='mt-5  border w-80 md:w-[900px]  rounded-lg'>
...
<div className='flex  justify-end mt-8  gap-6'>
    ...
    <button class=" px-4 py-2  bg-red-600  w-32 text-white  rounded-md  text-sm hover:opacity-90 hover:text-black hover:bg-emerald-500  mb-2 ml-4">Delete</button>
    <Link to="/edituser" class="px-4 py-2  bg-red-600  w-32 text-white text-sm text-center rounded-md  hover:opacity-90 hover:text-black hover:bg-emerald-500 mb-2 mr-4">Edit</Link>
</div>
