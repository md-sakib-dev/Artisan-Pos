...
<select className="border-0 border-b-2 border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-normal" name='group' as='select' onChange={handleChange} >
...
<select className="border-0 border-b-2 border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-normal" name='category' as='select' onChange={handleChange}>
...
<select className="border-0 border-b-2 border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-normal" name='size' as='select' onChange={handleChange}>
...
<input  type="text" name="name" id="name" value={values.name} onChange={handleChange} onBlur={handleBlur} placeholder='Enter Name'  class="border-0 border-b-2 border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-semibold"/>
{errors.name && touched.name ? (<p className="text-red-700 text-[12px] font-semibold">{errors.name}</p>):null}
</div>
<div className='flex flex-col justify-between '>
<p className='text-sm'>Group</p>
<select className="border-0 border-b-2 border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-normal" name='brand' as='select' onChange={handleChange}>
...
<select className="border-0 border-b-2 border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-normal" name='type' as='select' onChange={handleChange}>
...
{errors.type && touched.type ?(<p className=" text-red-700 text-[12px] font-normal">{errors.type}</p>): null}
</div>
...
<select className="border-0 border-b-2 border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-normal" name='house' as='select' onChange={handleChange}>
...
{errors.price && touched.price ? (<p className="text-red-700 text-[12px] font-normal">{errors.price}</p>):null}
</div>
</div>
<div>
