...
const EditPrice = () => {
 ...
 <div class=" mt-5 flex justify-center gap-4 items-center ">
...
<button class=" px-4 py-2  bg-red-600  w-28 text-white  rounded-lg  hover:opacity-90 hover:text-black hover:bg-emerald-500 mb-4">Search</button>
   ...
   <div className='flex flex-col justify-center items-center'>
         ...
         <form className='mt-5  border w-80 md:w-[700px]   rounded-lg' onSubmit={handleSubmit}>
          ...
          <div className='flex justify-end gap-8 items-center mt-2'>
