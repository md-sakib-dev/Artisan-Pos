...
const NewUser = () => {
  ...
  return (
    ...
    <div className=' w-80 md:w-full mx-auto border-2  rounded-2xl mt-12'>
        <h1 className='font-signature font-semibold text-2xl text-center border-b border-slate-200 py-3'>Add New User</h1>
      ...
      <div className='flex flex-col  justify-between items-center'>
        ...
        <label htmlFor="username" className='absolute text-sm text-black duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-800 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 font-normal'>
            Username
        </label>
        <div>
           <FaUser size={20} className='absolute top-4 right-4'/>
        </div>
        {errors.name && touched.name ? (<p className="text-red-700 text-[12px] font-normal">{errors.name}</p>):null}
    </div>
          <div className=' flex flex-col  gap-1 relative'>
                        ...
                        <label htmlFor="email" className='absolute text-sm text-black duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-800 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 font-normal'> 
                          Employee Name
                        </label>
                        <div>
                ...
                {errors.employee_name && touched.employee_name ?(<p className=" text-red-700 text-[12px] font-normal">{errors.employee_name}</p>): null}
                    ...
                    <div className=' flex flex-col  gap-1 relative'>
                        ...
                        <BiSolidUserCheck size={25} className='absolute top-4 right-4'/>
                        </div>
                        
                {errors.employee_id && touched.employee_id ?(<p className=" text-red-700 text-[12px] font-normal">{errors.employee_id}</p>): null}
            ...
            <select className="border-0 border-b-2 border-gray-300  text-sm  text-black   rounded-md  w-[250px] md:w-[250px] p-1 h-10 font-normal" name='Role' as='select' onChange={handleChange}>
            ...
            {errors.Role && touched.Role ?(<p className=" text-red-700 text-[12px] font-normal">{errors.Role}</p>): null}
            </div>
               
            <div className='flex flex-col gap-1 justify-between'>
            <p className='text-sm'>Branch</p>
            <select className="border-0 border-b-2 border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-normal p-1" name='Branch' as="select" onChange={handleChange}>
            <option value="" >Select an Branch</option>
            <option value="option1">Option 1</option>
            <option value="option2">Option 2</option>
            <option value="option3">Option 3</option>
        </select>
        {errors.Branch && touched.Branch ?(<p className=" text-red-700 text-[12px] font-normal">{errors.Branch}</p>): null}
               </div>
               </div>
                <div className='flex flex-col md:flex-row justify-around md:mt-2 gap-8'>
                  <div>
                    ...
                    <div className='flex flex-col gap-1 relative'>
                        ...
                        <label htmlFor="password" className='absolute text-sm text-black duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-800 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 font-normal'>
                            Password
                        </label>
                ...
                {errors.password && touched.password ?(<p className=" text-red-700 text-[12px] font-normal">{errors.password}</p>): null}
                </div>  
                ...
                <div className='flex flex-col gap-1 relative'>
                  ...
                  {errors.confirm_password && touched.confirm_password ?(<p className=" text-red-700 text-[12px] font-normal">{errors.confirm_password}</p>): null}
