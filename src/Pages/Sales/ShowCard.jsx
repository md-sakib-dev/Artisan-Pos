    ...
    <div className=' fixed inset-0 bg-black  backdrop-blur-sm bg-opacity-5    '>
     ...
     <div className='flex justify-center  p-4 md:p-5  border-b-2 dark:border-gray-600'>
       ...
       <div className=" flex flex-col gap-1 ">
              ...
              <div className='flex flex-col gap-1'>
      <p className='text-sm'>Pos Machine</p>
<select className="border-0 border-b-2 border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-normal"   name='group' as='select'  value={values.group} onChange={handleChange} >
        ...
        {errors.group ? (<p className=" text-red-700 text-[12px]  font-normal">{errors.group}</p>): null}
    </div>
            
       </div>
       <div className='flex flex-col md:flex-row md:justify-around gap-8'>
       <div className=" flex flex-col gap-1 ">
                <label htmlFor="serial" className='text-sm'>Card Number</label>
                ...
                {errors.mobile && touched.mobile && (<p className="text-red-700 text-[12px] font-normal">{errors.mobile}</p>)}
              </div>
       <div className='flex flex-col gap-1'>
      <p className='text-sm'>Card Type</p>
<select className="border-0 border-b-2 border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-normal"   name='newgroup' as='select'  value={values.newgroup} onChange={handleChange} >
            <option value="" >Select a Group</option>
            <option value="Admin">Admin</option>
            <option value="Branch Manager">Branch Manager</option>
            <option value="Pos Operator">Pos Operator</option>
        ...
        {errors.newgroup ? (<p className=" text-red-700 text-[12px]  font-normal">{errors.newgroup}</p>): null}
    </div>
   

       </div>
               
     <div className="flex justify-center items-center py-2 mb-5 bg-red-600 mt-2 w-44 text-white  rounded-md h-9 hover:opacity-90 hover:text-black hover:bg-emerald-500">
