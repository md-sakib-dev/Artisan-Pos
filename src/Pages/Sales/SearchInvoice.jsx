  ...
  return (
    <div className='w-full h-full mx-auto mt-16'>
      ...
      <div className=" flex flex-col gap-2 ">
                        ...
                        {errors.from && touched.from ? (<p className=" text-red-700 text-[12px]  font-normal">{errors.from}</p>): null}
                      </div>
                      <div className=" flex flex-col gap-2 ">
                        <label htmlFor="serial" className='text-sm'>Enter validation Code</label>
                        ...
                        {errors.to && touched.to ? (<p className=" text-red-700 text-[12px]  font-normal">{errors.to}</p>): null}
                      </div>
