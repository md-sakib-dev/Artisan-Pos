...
const closeModal=()=>{
  ...
  return (
    <div className='w-full h-full mt-12 mx-auto'>
      <div className='grid md:grid-cols-[60fr,40fr] gap-8'>
          ...
          <div className='flex flex-col justify-between'>
            <form className='flex flex-col md:flex-row justify-between items-center gap-5' onSubmit={handleSubmit}>
              ...
              <div className="mt-5 flex flex-col gap-0 ml-5">
                ...
                {errors.serial && touched.serial && (<p className="text-red-700 text-[12px] font-normal">{errors.serial}</p>)}
              </div>
              ...
              <div className="mt-5 flex flex-col gap-0">
                ...
                {errors.date && touched.date && (<p className="text-red-700 text-[12px] font-normal">{errors.date}</p>)}
              </div>
        ...
        <input type="text" value="0" class="h-16 px-4 text-2xl font-normal w-full bg-white border border-gray-300 rounded-md text-black "/>
        </div>
...
{showInput && (
      ...
      <div className='flex justify-center items-center gap-4 ml-2 mr-2'>
          <div>
        {showCard  &&  (
