...
const Wallet = ({closeModal}) => {
    ...
    const{values,errors,touched,handleBlur,handleChange,handleSubmit}= useFormik({
        ...
        return (
            ...
            <div className=' fixed inset-0 bg-black  backdrop-blur-sm bg-opacity-5    '>
             ...
             <div className='flex justify-end border-b-2  dark:border-gray-600'>
                ...
                <h1 className='font-signature text-black font-semibold text-2xl text-center '>Wallet</h1>
        ...
        <select className="border-2 border-gray-300 text-sm   text-black   rounded-md  w-36 h-10 font-normal"   name='tform' as='select'  value={values.tform} onChange={handleChange} >
                    <option value="" >Select an form</option>
                    <option value="Admin">A</option>
                    <option value="Admin">B</option>     
                </select>
                {errors.tform && touched.tform ? (<p className=" text-red-700 text-[12px]  font-normal">{errors.tform}</p>): null}
            </div>
