    ...
    return (
        ...
        <div className=' fixed inset-0 bg-black  backdrop-blur-sm bg-opacity-5 '>
         ...
         <div className='flex justify-center  p-4 md:p-5  border-b-2 dark:border-gray-600'>
            ...
            <div className='text-gray-400 bg-transparent hover:bg-white hover:text-gray-900 rounded-md text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white' onClick={closeModal}>
           ...
           <div className="mt-5 flex flex-col gap-0 ml-5">
                  ...
                  <div className="mt-5 flex flex-col gap-0 ml-5">
                    ...
                    {errors.slip && touched.slip && (<p className="text-red-700 text-[12px] font-normal">{errors.slip}</p>)}
                  </div> 
