          ...
          <div className='flex flex-col justify-between'>
            <form className='flex flex-col md:flex-row  items-center gap-5' onSubmit={handleSubmit}>
              ...
              <div className="mt-5 flex flex-col gap-0 ml-5">
                ...
                {errors.barcode && touched.barcode && (<p className="text-red-700 text-[12px] font-normal">{errors.barcode}</p>)}
              </div>
              <div className="mt-5 flex flex-col gap-0 ml-5">
                ...
                {errors.qty && touched.qty && (<p className="text-red-700 text-[12px] font-normal">{errors.qty}</p>)}
              </div>
