...
import { mobilePaySchema } from '../../schemas';
...
const MobilePayment = ({closeModal}) => {
   ...
   const{values,errors,touched,handleBlur,handleChange,handleSubmit}= useFormik({
    initialValues:initialValues,
        validationSchema: mobilePaySchema,
  ...
  return (
    ...
    <div className=' fixed inset-0 bg-black  backdrop-blur-sm bg-opacity-5    '>
     ...
     <div className='flex justify-center  p-4 md:p-5  border-b-2 dark:border-gray-600'>
        ...
        <h1 className='font-signature text-black font-bold text-2xl text-center '>Mobile Payment</h1>
...
<select className="border-0 border-b-2 border-gray-300 text-sm  p-1  text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-normal"   name='group' as='select'  value={values.group} onChange={handleChange} >
        ...
        {errors.group && touched.group ? (<p className=" text-red-700 text-[12px]  font-normal">{errors.group}</p>): null}
    </div>
...
<select className="border-0 border-b-2 border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-semibold"   name='newgroup' as='select'  value={values.newgroup} onChange={handleChange} >
        ...
        {errors.newgroup && touched.newgroup? (<p className=" text-red-700 text-[12px]  font-normal">{errors.newgroup}</p>): null}
    </div>
