...
const ShowSize = ({closeModal}) => {
  ...
  return (
    ...
    <div className='flex items-center justify-between p-4 md:p-5 border-b border-b-gray-600 rounded-t dark:border-gray-600'>
     ...
     <h1 className='font-signature text-black font-semibold text-2xl text-center '>Merge Size</h1>
...
<select className="border-0 border-b-2 border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-normal" name='size' as='select'  value={values.size} onChange={handleChange} >
...
<select className="border-0 border-b-2 border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-normal"   name='newsize' as='select'  value={values.newsize} onChange={handleChange} >
            <option value="" >Select a Size</option>
            <option value="Admin">Admin</option>
            <option value="Branch Manager">Branch Manager</option>
            <option value="Pos Operator">Pos Operator</option>
