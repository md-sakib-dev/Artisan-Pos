...
const ShowType = ({closeModal}) => {
  ...
  return (
    ...
    <div className='flex items-center justify-between p-4 md:p-5 border-b  rounded-t dark:border-gray-600'>
     ...
     <h1 className='font-signature text-black font-semibold text-2xl text-center '>Merge Type</h1>
...
<select className="border-0 border-b-2 border-gray-600 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-normal" name='type' as='select'  value={values.type} onChange={handleChange} >
        ...
        {errors.type ? (<p className=" text-red-700 text-[12px]  font-normal">{errors.type}</p>): null}
    </div>
    <div className='flex flex-col gap-5'>
