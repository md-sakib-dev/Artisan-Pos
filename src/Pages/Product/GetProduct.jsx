...
const GetProduct = () => {
  ...
  return (
    <div className='mt-12 w-full h-full mx-auto '>     
      ...
      <div class=" mt-5 flex flex-col gap-2 md:flex-row md:gap-4 justify-center items-center " onSubmit={handleSubmit}>
...
<div className='flex flex-col justify-center items-center'>
   <div className='mt-5  border w-80 md:w-[800px]  rounded-lg'>
    <div className='flex flex-col md:flex-row justify-around items-center mt-2'>
      <div className='flex flex-col '>
      <label for="id" class="mb-2 text-sm">Group</label>
     <input type="text" name="group" id="group" placeholder="" class="border-2 bg-gray-200  border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-normal"/>
      </div>
      <div className='flex flex-col '>
      <label for="id" class="mb-2 text-sm">Type</label>
  <input type="text" name="type" id="type" placeholder="" class="border-2  bg-gray-200  border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-normal"/>
      </div>
      <div className='flex flex-col'>
      <label for="id" class="mb-2 text-sm">Category</label>
     <input type="text" name="category" id="category" placeholder="" class=" border-2 bg-gray-200  border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-normal"/>
      </div>
    </div>
    ...
    <div className='flex flex-col '>
      ...
      <input type="text" name="style" id="style" placeholder="" class="border-2 bg-gray-200   border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-normal"/>
      </div>
      <div className='flex flex-col '>
      <label for="id" class="mb-2 text-sm">Brand</label>
      <input type="text" name="brand" id="brand" placeholder="" class="border-2 bg-gray-200  border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10 font-normal"/>
      </div>

      <div className='flex flex-col '>
  <label htmlFor="password" className="mb-2 text-sm">Size</label>
  <input type="password" id="size" name="size" placeholder="" className=" border-2 bg-gray-200  border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10  font-normal" />
</div>

    </div>
    <div className='flex flex-col ml-2'>
  <label htmlFor="password" className="mb-2 text-sm">Color</label>
  <input type="password" id="color" name="color" placeholder="" className=" border-2 bg-gray-200  border-gray-300 text-sm   text-black   rounded-md  w-[250px] md:w-[250px] h-10  font-normal" />
</div>
<div className='flex justify-end mt-5 gap-8 items-center'>
