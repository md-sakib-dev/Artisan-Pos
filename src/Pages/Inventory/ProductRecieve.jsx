...
const ProductRecieve = () => {
  ...
  return (
    <div className='w-full h-full mx-auto mt-16'>
      <div className='flex flex-col md:flex-row justify-between md:justify-center items-center gap-8'>
      ...
      <div className='flex flex-col gap-0.5'>
        ...
        <select className="border-2 border-gray-300 text-sm   text-black   rounded-md  w-56 h-10 font-semibold"   name='deliver' as='select'  value={values.deliver} onChange={handleChange} >
            ...
            <div className=" flex flex-col gap-1 ">
                        ...
                        <input type="number" name="deliverrno" id="deliverno" placeholder="Enter voucher" value={values.deliverno} onChange={handleChange} onBlur={handleBlur} className="border border-gray-300 rounded-md px-3 py-2 mb-4 w-56"/>
                        {errors.deliverno && touched.deliverno ? (<p className=" text-red-700 text-[12px]  font-semibold">{errors.deliverno}</p>): null}
                  
                      </div>
                      <div className=" flex flex-col gap-1 ">
                        <label htmlFor="serial" className='text-sm'>Voucher NO</label>
                        <input type="text" name="voucherno" id="voucherno" placeholder="" value={values.voucherno} onChange={handleChange} onBlur={handleBlur} className="border border-gray-300 rounded-md px-3 py-2 mb-4 w-56"/>
                  
                      </div>
                      <div>

                      <button class=" text-sm px-4 py-2  bg-red-600 w-60 md:w-56 text-white  rounded-md  hover:opacity-90 hover:text-black hover:bg-emerald-500 mt-2">Load</button>
                      </div>
