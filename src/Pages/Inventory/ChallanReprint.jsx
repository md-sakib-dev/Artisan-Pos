...
const ChallanReprint = () => {
  ...
  return (
    <div className='mt-16 w-full h-full mx-auto'>
      <h1 className='text-center text-3xl font-signature font-semibold'>Chalan Print</h1>
      <form class=" mt-10 flex flex-col gap-2 md:flex-row md:gap-4 justify-center   " onSubmit={handleSubmit}>
         <div className='flex flex-col gap-1'>
          <label htmlFor="" className='text-sm '>Return Chalan No.</label>
         ...
         <div className='flex flex-col gap-1'>
              <p className='text-sm'>Chalan Type</p>
